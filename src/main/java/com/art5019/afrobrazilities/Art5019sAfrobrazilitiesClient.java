...
@EventBusSubscriber(modid = Art5019sAfrobrazilities.MODID, value = Dist.CLIENT)
public class Art5019sAfrobrazilitiesClient {
    public Art5019sAfrobrazilitiesClient(ModContainer container) {
