...
public enum Fortunes {
    ...
    GUARANTEED_TRIUMPH(9, "art5019afrobrazilities.fortune.full.guaranteed_triumph", "art5019afrobrazilities.fortune.name.guaranteed_triumph",5,7),
    GUARANTEED_FAIL(10, "art5019afrobrazilities.fortune.full.guaranteed_fail", "art5019afrobrazilities.fortune.name.guaranteed_fail",6,-6),
